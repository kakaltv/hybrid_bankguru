...
public class Level_06_Register_Login_Dynamic_Locator extends BaseTest{
	WebDriver driver;
	...
	public void Login_03_Open_Page_At_Footer() {
		...
		myOrderPage = (MyOrderPageObject) myAccountPage.getFooterPageByPageName(driver, "Orders");
		
		// My Order Page -> My Account Page
		myAccountPage = (MyAccountPageObject) myOrderPage.getFooterPageByPageName(driver, "My account");
	...
	public void Login_04_Open_Page_At_Footer() {
		...
		// My Order Page -> My Account Page
		myOrderPage.openFooterPageByPageName(driver, "My account");
		myAccountPage = PageGeneratorManager.getMyAccountPage(driver);
		
		// My Account Page -> Search Page
		myAccountPage.openFooterPageByPageName(driver, "Search");
